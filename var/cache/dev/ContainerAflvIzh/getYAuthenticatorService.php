 ...
 */
class getYAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\YAuthenticator' shared autowired service.
     *
     * @return \App\Security\YAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'YAuthenticator.php';

        return $container->privates['App\\Security\\YAuthenticator'] = new \App\Security\YAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
